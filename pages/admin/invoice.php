                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                echo '<div class="btn-group pull-right">
                                    <a href="CreateInvoice.php?id='.$id.'"><button class="btn btn-success">Add New <i class="icon-plus icon-white"></i></button></a>
                                </div>
                                ...
                                $query="select * from invoicetable where userdetails_id=$id;";
...
echo " <center><button type='button' style='width:75%; background-color:{$row['button_color']}; border-color:white; background-image:none;' class='btn btn-danger' data-toggle='confirmation' data-singleton='true' data-popout='true' data-placement='top' data-btn-ok-label='Paid' data-btn-ok-icon='fa fa-thumbs-o-up'
        data-btn-ok-class='btn-success'
        data-btn-cancel-label='Cancel' data-btn-cancel-icon='fa fa-ban'
        data-btn-cancel-class='btn-danger'
        data-title='Paid the Invoice?'  id='{$row['invoice_no']}' onclick='myfunc(this.id);' >
