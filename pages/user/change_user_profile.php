...
<div class="content-wrapper" style="min-height: 490px;">
  <section class="content-header">
    <h1 style="margin-left:6px; margin-right:6px; display:inline-block; " class="md-headline">Change User Profile</h1> 
...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Change Username</a></li>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      <!--home tab content start-->
      <div class="w3-card-4" style="width:80%;  margin: 20px auto; float: none; " layout-align="center center">
          <header class="w3-container w3-light-grey">
            <h3 class="md-headline">Change Username</h3>
          </header>
          <div class="w3-container">
            <form >
             <div class="input-group" style="margin: 20px auto;">
               <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
               <input id="username" type="text" class="form-control" name="username" placeholder="Change Username">
             </div>
             ...
             <div class="input-group" style="margin: 20px auto;">
                <div class="alert alert-info" style="display:none;" id="successdiv">
                   Your username has been changed.
                </div>
                 <div class="alert alert-danger" style="display:none;" id="alertdiv">
                    <strong>Username exist!&nbsp;</strong>Username has to be unique for every user  
                </div>
             </div>
            </form>
          </div>
          ...
          <div class="w3-container">
            <form>
             <div class="input-group" style="margin: 20px auto;">
               ...
               <input id="email" type="text" class="form-control" name="old_password" placeholder="Old Password">
             </div>
           
            
             <div class="input-group" style="margin: 20px auto;">
               <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
               <input id="email" type="text" class="form-control" name="new_Password" placeholder="New Password">
             </div>
           
            
             <div class="input-group" style="margin: 20px auto;">
               <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
               <input id="email" type="text" class="form-control" name="confirm_password" placeholder="Confirm Password">
             </div>
